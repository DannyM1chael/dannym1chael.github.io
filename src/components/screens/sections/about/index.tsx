...
import { contactInfo, PersonalInfoItem, personalInfo } from "@/api";
				...
				<div className="container mx-auto px-4">
					<div className="text-center mb-8">
						...
						<p className="text-base">
							...
							high-performance, scalable web applications. Proven leadership in
							designing and executing large-scale projects with complex system
							architecture, focusing on real-time data processing, performance
							optimization, and user-centric design. Adept at managing
							cross-functional teams and driving impactful results through
