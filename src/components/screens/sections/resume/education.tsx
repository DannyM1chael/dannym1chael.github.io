  ...
  <>
    ...
    <div className="resume-item">
      ...
      <ul>
        ...
        <li>
          HTML, CSS (SASS) and Javascript, jQuery, frameworks - Vanilla JS,
          React JS
        </li>
    ...
    <div className="resume-item">
      <h5>2018</h5>
      <p>
        <em>Essential Cloud Infrastructure: Foundation by Google Cloud</em>
      </p>
      <p>
        <em>Essential Cloud Infrastructure: Core Services by Google Cloud</em>
      </p>
    </div>
    <div className="resume-item">
      <h5>2017</h5>
      <p>
        <em>
          Programming for Everybody (Getting Started with Python) by University
          of Michigan
        </em>
      </p>
      <p>
      ...
      <p>
        <em>
          Google Cloud Platform Fundamentals: Core Infrastructure by Google
          Cloud
        </em>
      </p>
    </div>
    <div className="resume-item">
      <h5>2013</h5>
      <p>
        <em>Microsoft Certified Technology Specialist</em>
      </p>
    </div>
    <div className="resume-item">
      <h5>2004 - 2007</h5>
      <p>
        <em>Irkutsk State Railway University</em>
      </p>
