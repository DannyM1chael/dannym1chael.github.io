export const Summary = () => (
  <>
    ...
    <div className="pl-5 pb-0 mt-[-8px] border-l-2 border-primary-dark relative">
      <div className="absolute w-4 h-4 rounded-full left-[-9px] top-0 bg-white border-2 border-primary-dark" />
